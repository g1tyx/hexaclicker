...
var cnItems = {
    ...
    'Press CTRL + Left-click to activate the utility hexa': '按CTRL + 左键点击 激活效用六边形',
    'Every utility hexa costs 1 point. You receive utility points every 10 levels': '每个效用六边形成本1点。 您每10级获得一次效用点数',
